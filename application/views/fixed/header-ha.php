            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right"><?php if ($this->aauth->get_user()->roleid == 5) { ?>
                        ...
                        ?></select></li>
                                            ...
                                            <div class="card-header p-0 pb-1 border-0 mt-1" id="heading3" role="tab" style="display:none;">
                                                <a class=" text-uppercase black" data-toggle="collapse"
                                            ...
                                            <div class="card-collapse collapse mb-1 " id="accordion3" role="tabpanel" aria-labelledby="heading3" aria-expanded="true" style="display:none;">
                                                <div class="card-content">
                                                    <ul>
                                                        <li><a class="dropdown-item"
                                ...
                                <li class="col-md-3">
                                    ...
                                    <div id="accordionWrap3" role="tablist" aria-multiselectable="true">
                                        <div class="card border-0 box-shadow-0 collapse-icon accordion-icon-rotate">
                                            <div class="card-header p-0 pb-1 border-0 mt-1" id="heading10" role="tab" style="display:none;">
                                                <a class=" text-uppercase black" data-toggle="collapse"
                                            ...
                                            <div class="card-collapse collapse mb-1 " id="accordion10" role="tabpanel"
                                                 aria-labelledby="heading10" aria-expanded="true" style="display:none;">
                                                <div class="card-content">
                                                    <ul>
                                                        <li><a class="dropdown-item"
                                                               href="<?php echo base_url(); ?>plugins/recaptcha"><i
                                            ...
                                            <div class="card-header p-0 pb-1 border-0 mt-1" id="heading12" role="tab" style="display:none;">
                                                <a class=" text-uppercase black" data-toggle="collapse"
                                            ...
                                            <div class="card-collapse collapse mb-1 " id="accordion12" role="tabpanel"
                                                 aria-labelledby="heading12" aria-expanded="true" style="display:none;">
                                                <div class="card-content">
                                                    <ul>
                                                        <li><a class="dropdown-item"
    ...
    <div class="navbar-container main-menu-content" data-menu="menu-container">
        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            if ($this->aauth->premission(1)) { ?>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                      data-toggle="dropdown"><i
                                class="ft-layers"></i><span>Sales Order</span></a>
                    <ul class="dropdown-menu">
                        <li data-menu=""><a class="dropdown-item"
                                            href="<?php echo base_url(); ?>salesorder"
                                            data-toggle="dropdown"><i
                                        class="ft-umbrella"></i> Management
                            </a>
                        </li>
                    </ul>
                </li>
...
<!--                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"-->
<!--                                                                      data-toggle="dropdown"><i-->
<!--                                class="ft-layers"></i><span>Application</span></a>-->
<!--                    <ul class="dropdown-menu">-->
<!--                        <li data-menu=""><a class="dropdown-item"-->
<!--                                            href="--><?php //echo base_url(); ?><!--Application"-->
<!--                                            data-toggle="dropdown"><i-->
<!--                                        class="ft-umbrella"></i> Users Management-->
<!--                            </a>-->
<!--                        </li>-->
<!--                    </ul>-->
<!--                </li>-->
	            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
		            ...
		            <ul class="dropdown-menu">
			            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
						            class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
							            class="ft-list"></i> Users </a>
				            <ul class="dropdown-menu">
					            <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>appusers/add"
					                                data-toggle="dropdown"> New User </a>
					            </li>
					            <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>appusers"
					                                data-toggle="dropdown"> Manage Users </a>
					            </li>
