                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                <div class="form-group row">
                                    <div class="fcol-sm-12">
                                        <h3 class="title">
                                            <?php echo $this->lang->line('Bill To') ?> <a href='#' class="btn btn-primary btn-sm round" data-toggle="modal" data-target="#addCustomer">
                                ...
                                <div class="form-group row">
                                    <div class="frmSearch col-sm-12"><label for="cst" class="caption"><?php echo $this->lang->line('Search Client'); ?></label>
                                        <input type="text" class="form-control round" name="cst" id="customer-box" placeholder="Enter Customer Name or Mobile Number to search" autocomplete="off" />
                                ...
                                <div id="customer">
                                    ...
                                    <hr>
                                    <div id="customer_pass"></div><?php echo $this->lang->line('Warehouse') ?> <select id="s_warehouses" class="form-control round">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invocieno" class="caption"><?php echo $this->lang->line('Invoice Number') ?></label>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control round" placeholder="Invoice #" readonly name="invocieno" value="<?php echo $lastinvoice + 1 ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6"><label for="invociedate" class="caption"><?php echo $this->lang->line('Invoice Date'); ?></label>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control round required" placeholder="Billing Date" name="invoicedate" data-toggle="datepicker" autocomplete="false">
                                        </div>
                                    </div>
                    ...
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tbody id="item0">
                                ...
                                <tr>
                                    <td colspan="6"><textarea id="dpid-0" class="form-control" name="product_description[]" placeholder="<?php echo $this->lang->line('Enter Product description'); ?> (Optional)" autocomplete="off"></textarea><br></td>
                                    <td colspan="2">
                                        <select name="employeeId[]" class="form-control input-md employee-dropdown">
                                            <?php
                                            foreach ($employees as $employee) {
                                                $serviceIds = $employee['service'];
                                                $cid = $employee['id'];
                                                $acn = $employee['name'];
                            ...
                            <tbody id="last_item_tbody">
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <td align="left" colspan="2"><span class="currenty lightMode"><?= $this->config->item('currency'); ?></span>
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <td align="left" colspan="2"><input type="text" class="form-control form-control-sm discVal" onkeypress="return isNumber(event)" placeholder="Value" name="disc_val" autocomplete="off" value="0" onkeyup="billUpyog()">
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    <td colspan="2">
                                        ...
                                        <div class="col-sm-6"><label for="payment_amount" class="caption"><?php echo $this->lang->line('Payment Amount') ?></label>

                                            <div class="input-group">
                                                <div class="input-group-addon"><span class="icon-bookmark-o" aria-hidden="true"></span></div>
                                                <input type="text" class="form-control round" placeholder="Payment Amount" name="payment_amount">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6"><label for="payment_amount2" class="caption"><?php echo $this->lang->line('Payment Amount 2') ?></label>

                                            <div class="input-group">
                                                <div class="input-group-addon"><span class="icon-bookmark-o" aria-hidden="true"></span></div>
                                                <input type="text" class="form-control round" placeholder="Payment Amount 2" name="payment_amount2">
                                            </div>
                                        </div>
                                    </td>
                                    <td align="right" colspan="6"><input type="submit" class="btn btn-success sub-btn btn-lg" value="<?php echo $this->lang->line('Generate Invoice') ?> " id="submit-data" data-loading-text="Creating...">
                                    </td>
...
<script>
    var services = [
        ...
        foreach ($services as $row) {
            $cid = $row['id'];
            $acn = $row['name'];
            // echo "<option value='$acn' data-serviceid=$cid>$acn</option>";
            echo "{
                text: '$acn',
                serviceId: $cid
            },";
    ...
    $(document).ready(function() {
        ...
        function filterService(tbodyId) {
            const servicesDropdown = $("tbody#" + tbodyId + " select[name^='product_name'");
            const selectedEmployeeServices = $("tbody#" + tbodyId + " .employee-dropdown :selected").data('serviceid');
            const servicesData = [];
            var isFirstOption = true;
            services.forEach((elem, index) => {
                if (selectedEmployeeServices.includes(elem.serviceId)) {
                    servicesData.push({
                        id: elem.text,
                        text: elem.text,
                        disabled: false,
                        selected: isFirstOption
                    })
                    isFirstOption = false
                } else {
                    servicesData.push({
            ...
            servicesDropdown.trigger('change')
        }
        $(".employee-dropdown").on("change", function(event) {
            const tbodyId = $(event.target).closest('tbody')[0].id
            filterService(tbodyId)
        })
