                    ...
                    <div class="col-md-8">
                        ...
                        <div class="">
                            ...
                            <div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                    <?php if($details['picode']) {echo $details['picode'];} ?>
                                </div>
                            ...
                            <div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                    <?php if($details['reg_date']) {
                                        $time = strtotime($details['reg_date'].'+ 0 minutes');
                            ...
                            <div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                    <?php if($details['tavalod']) {
                                        $time = strtotime($details['tavalod'].'+ 0 minutes');
                                        echo $this->jdf->jdate('l, j F Y',$time);
                            ...
                            <div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong>first presence</strong>
                                </div>
                                <div class="col-md-10">
                                    <?php if($details['avalin_hozor']) {
                                        $time = strtotime($details['avalin_hozor'].'+ 0 minutes');
                                        echo $this->jdf->jdate('l, j F Y',$time);
                            ...
                            <div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong>last presence</strong>
                                </div>
                                <div class="col-md-10">
                                    <?php if($details['akharin_hozor']) {
                                        $time = strtotime($details['akharin_hozor'].'+ 0 minutes');
                                        echo $this->jdf->jdate('l, j F Y',$time);
                            ...
                            <?php
                            $count_hozor=0;
                            $count_service=0;$chk_factor_code="0";
                            $pay_price=0;
                            foreach($events as $item){

                                if($item['description']!=$chk_factor_code){
                                    $chk_factor_code=$item['description'];
                                    $count_hozor++;
                            ...
                            <div class="row m-t-lg">
                                ...
                                <div class="col-md-10">
                                    <?php if($details['moaaref']) {echo $details['moaaref'];} ?>
                                </div>
                            ...
                            <div class="row m-t-lg">
                                <div class="col-md-2">
                                    <strong>All pay</strong>
                                </div>
                                <div class="col-md-10">
                                    <?php  echo $details['kole_hazine']+$pay_price;  ?>
                                </div>
