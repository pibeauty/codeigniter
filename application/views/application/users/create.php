    ...
    <div class="card card-block bg-white">
        ...
        <form method="post" id="data_form" class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text"
                           class="form-control margin-bottom required" id="username" name="username"
                           placeholder="username">
                </div>
	            <div id="un_username" class="danger col-sm-10" style="display: none;"><span>Unavailable</span></div>
	            <div id="av_username" class="success col-sm-10" style="display: none;"><span>Available</span></div>
            </div>
...
//                        }
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="hidden" value="appusers/submit_user" id="action-url">
                </div>
            </div>
    ...
    $(document).on('change', "#username", function (e) {
        ...
        if (userName !== ''){
            $.ajax({
                ...
                url: baseurl + 'appusers/checkAvailability',
                type: 'POST',
                data: $('form').serialize(),
                dataType: 'json',
                success: function (data) {
                    if(data){
                        document.querySelector('#un_username').style.display = '';
                        document.querySelector('#av_username').style.display = 'none';
                    }
                    else
                    {
                        document.querySelector('#un_username').style.display = 'none';
                        document.querySelector('#av_username').style.display = '';
                    }
                },
                error: function (data) {
                    console.log(data);
