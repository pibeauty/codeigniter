                                    ...
                                    <p>
                                        <?php
                                            switch ($paymentStatus) {
                                                ...
                                                case 'rejected':
                                                    echo "پرداخت شما انجام نشد.";
                                                    break;
                                                
                                                case 'unknown':
                                                    echo "وضعیت پرداخت مشخص نیست";
                                                    break;
                                                
                                                default:
                                                    echo "اطلاعات پرداخت دریافت نشد";
                                                    break;
                                            }
                                        ?>
                                    </p>
                                    <div class="form-row" dir="rtl" align="center">
                                        <div class="form-group col-md-12 boxed">
                                            ...
                                            foreach (json_decode($data) as $item){
                                               // jdate('H:i:s P | l, j F Y',time())

                                                if($i==0){
                                                    $time = strtotime($item->date_fromSET.'+ 210 minutes');
                                                    $date_fromSET = date('H:i',$time);
                                                    $x=  $this->jdf->jdate('l, j F | H:i',$time);
                                                    // echo " رزرو در روز: ".$dat." ماه <br/>";
                                                    $i++;
                                                }

                                            }print_r(" خانم  ".$name." به امید دیدار شما در ".$x." در پی سالن ");
                                            ?>
                                       </div>
